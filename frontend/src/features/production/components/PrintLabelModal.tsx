...
// Component that displays a dialog with part credentials and prints labels
export function PrintLabelModal({
  ...
  // Fetches master parts to cross-reference model details
  ...
  // Queries the backend for a centralized incremental sequence label ID
  ...
  // Sends an array of bytes to the Web Bluetooth characteristic in chunk increments
  ...
  // Generates ESC/POS command sequences for thermal label printers
...
<script>
  ...
  // Initiates print flow using either Web Bluetooth or browser window fallbacks
  ...
  // Formats label timestamp including active member initials
  ...
  // Retrieves model details from parts registry
  ...
  // Decodes barcode customer details
          ...
          <div className="p-6 border-r border-slate-150 dark:border-slate-800 w-full md:w-80 shrink-0 bg-slate-50 dark:bg-slate-950 flex flex-col justify-between">
            <div className="space-y-5 flex-1">
              <div>
                ...
                <div className="text-xl font-black text-slate-800 dark:text-white">{targetTotal} <span className="text-xs text-slate-400 font-medium">pcs</span></div>
              </div>
              <div>
            ...
            <div className="bg-white w-full max-w-[460px] border-[2px] border-black shadow-md text-black relative select-none">
              ...
              <div className="flex border-b-[2px] border-black" style={{ minHeight: '68px' }}>
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-3 py-2 text-center">
                  ...
                  <span style={{ fontSize: customerUniqueItems.length > 1 ? '22px' : '38px', fontWeight: 900, lineHeight: 1.05, marginTop: '2px' }}>
              ...
              <div className="flex border-b-[2px] border-black">
                ...
                <div className="flex flex-col items-center justify-center p-1.5" style={{ width: '33%' }}>
                  ...
                  <span style={{ fontSize: '26px', fontWeight: 900, lineHeight: 1 }}>{kelipatan}</span>
                </div>
              </div>
              <div className="flex items-center justify-center p-3">
                {qrPreviewUrl ? (
                  <img src={qrPreviewUrl} alt="QR" style={{ width: '155px', height: '155px' }} />
                ) : (
