                  ...
                  <div className="grid grid-cols-2 gap-3.5">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={handleManualInput}
                        placeholder="e.g., INJ F2"
                        className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-3 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 text-center"
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={handleManualInput}
                        placeholder="e.g., 3000T"
                        className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-3 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 text-center font-bold"
                      />
                    </div>
                  </div>
