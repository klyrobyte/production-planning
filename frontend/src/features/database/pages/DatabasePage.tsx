...
export default function DatabasePage() {
  ...
  const [lastDeletedPart, setLastDeletedPart] = useState<PartItem | null>(null);
    ...
    for (let i = 1; i < lines.length; i++) {
      ...
      if (finalPartNumber !== '') {
        ...
        const newPart: PartItem = {
          ...
          backup_line: backupLine.trim() || homeLine.trim(),
          home_line: homeLine.trim(),
    ...
    <div className="space-y-6 text-left pb-12">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div className="text-left">
          ...
          <h2 className="text-2xl font-black uppercase tracking-tight text-slate-800 dark:text-white mt-0.5">Master Parts Database</h2>
        </div>
        {userRole === 'super-admin' && (
          <button
            onClick={handleDeleteAllParts}
            className="flex items-center justify-center gap-2 rounded-xl px-4 py-3 text-xs font-bold uppercase tracking-wider text-white bg-rose-600 hover:bg-rose-700 shadow-lg transition hover:opacity-90 active:scale-95 cursor-pointer shrink-0"
          >
      ...
      {successMsg && (
        <div className="rounded-xl border border-emerald-100 dark:border-emerald-950/30 bg-emerald-50 dark:bg-emerald-950/20 p-4 text-xs font-bold text-emerald-700 dark:text-emerald-400 flex items-center justify-between animate-in fade-in duration-200">
      ...
      {/* Page Tabs */}
      <div className="flex bg-slate-100 dark:bg-slate-950 p-0.5 rounded-lg border border-slate-200 dark:border-slate-800 gap-0.5 select-none w-fit">
        <button 
          className="px-4 py-2 text-xs font-black uppercase tracking-wider rounded-md bg-[#E76114] text-white shadow-sm"
        >
          Master Parts Database
        </button>
        <button 
          disabled
          className="px-4 py-2 text-xs font-black uppercase tracking-wider rounded-md text-slate-400 dark:text-slate-655 cursor-not-allowed"
        >
          Data Converter (Coming Soon)
        </button>
        <button 
          disabled
          className="px-4 py-2 text-xs font-black uppercase tracking-wider rounded-md text-slate-400 dark:text-slate-655 cursor-not-allowed"
        >
          Leader PIN Registry (Coming Soon)
        </button>
      </div>
            ...
            <div className="p-6">
              ...
              {activeTab === 'csv' && (
                <div className="space-y-5">
                  ...
                  {csvError && (
                    <div className="bg-rose-50 dark:bg-rose-950/20 border border-rose-250 rounded-xl p-3.5 text-rose-800 dark:text-rose-450 text-[11px] font-medium flex items-center gap-2.5">
                        ...
                        {parsedPreview.slice(0, 5).map((part, index) => (
                          <div key={index} className="p-3 hover:bg-slate-50 dark:hover:bg-slate-950 transition-colors flex justify-between items-center text-[10px]">
                            ...
                            <div className="text-right">
                              <span className="font-extrabold text-emerald-600 dark:text-emerald-450 bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200/50 dark:border-emerald-900/50 px-2 py-0.5 rounded text-[9px] uppercase tracking-wider">
                  ...
                  <div className="grid grid-cols-2 gap-3.5">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={handleManualInput}
                        placeholder="e.g., F2 MC 1"
                        className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-3 text-xs font-semibold text-slate-705 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 font-bold"
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <input
                          ...
                          onChange={handleManualInput}
                          placeholder="F2"
                          className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 text-center"
                        />
                        <input
                          type="text"
                          name="tonnage"
                          ...
                          onChange={handleManualInput}
                          placeholder="2500T"
                          className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 text-center font-bold"
                        />
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-3.5">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={handleManualInput}
                        placeholder="72"
                        className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-2 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 font-bold font-mono"
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={handleManualInput}
                        placeholder="1"
                        className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-2 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 font-bold"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-3 gap-3.5">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={handleManualInput}
                        placeholder="MOLD-01"
                        className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-2 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900"
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        onChange={handleManualInput}
                        placeholder="1.25"
                        className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-2 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary focus:bg-white dark:focus:bg-slate-900 font-mono"
                      />
                    </div>
          ...
          <div className="rounded-3xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-6 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex flex-wrap gap-3 w-full md:w-auto">
              <select
                ...
                className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 py-2 px-3 text-xs font-bold text-slate-705 dark:text-slate-200 outline-none transition focus:border-brand-primary cursor-pointer"
              >
              ...
              <table className="w-full border-collapse text-left">
                <thead>
                  <tr className="border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-white">
                    <th className="px-6 py-4">Part Identity</th>
                    <th className="px-6 py-4">Sebango / Model</th>
                    <th className="px-6 py-4">Line & Machine</th>
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 text-xs font-semibold text-slate-700 dark:text-white">
                  {isLoading ? (
                    ...
                    <tr>
                      <td colSpan={5} className="px-6 py-12 text-center text-slate-400">
                        Tidak ada part ditemukan yang sesuai kriteria.
                      </td>
                    </tr>
                  ) : (
                    paginatedParts.map((part) => (
                      <tr key={part.part_number} className="hover:bg-slate-50/40 dark:hover:bg-slate-800/30 transition-colors">
                        <td className="px-6 py-4 text-left">
                          <div className="font-extrabold text-slate-850 dark:text-white font-mono">{part.part_number}</div>
                          <div className="text-[10px] text-slate-400 dark:text-slate-400 font-medium max-w-[220px] truncate mt-0.5">{part.part_name}</div>
                        </td>
                        <td className="px-6 py-4 text-left">
                          <div className="font-extrabold text-slate-700 dark:text-white font-mono">{part.sebango}</div>
                          <div className="text-[10px] text-slate-450 dark:text-slate-400 mt-0.5">{part.customer} / {part.model}</div>
                        </td>
                        <td className="px-6 py-4 text-left">
                        ...
                        <td className="px-6 py-4 text-left font-mono text-[10px] text-slate-500 dark:text-slate-350">
                          <div>CT: <span className="font-bold text-slate-700 dark:text-white">{part.cycle_time}s</span> | Cavity: <span className="font-bold text-slate-700 dark:text-white">{part.cavity}</span></div>
                          <div className="mt-0.5">Spec: <span className="font-bold text-slate-700 dark:text-white">{part.spec}</span> | Weight: <span className="font-bold text-slate-700 dark:text-white">{part.weight}kg</span></div>
                        </td>
        ...
        <div className="fixed inset-0 bg-slate-900/60 dark:bg-slate-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto animate-in fade-in duration-200">
          <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col my-8 animate-in zoom-in-95 duration-200 max-h-[90vh]">
            ...
            <form onSubmit={handleSaveRevision} className="p-6 space-y-5 overflow-y-auto text-left">
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      value={editForm.area}
                      onChange={handleEditInput}
                      className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-2 px-3 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary text-center"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={handleEditInput}
                      className="w-full rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 py-2 px-3 text-xs font-semibold text-slate-700 dark:text-slate-200 outline-none transition focus:border-brand-primary text-center font-bold"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200/50 dark:border-slate-800/50">
                <div className="text-[10px] font-extrabold text-blue-650 dark:text-blue-450 uppercase tracking-wider flex items-center gap-1.5 border-b border-slate-200/50 dark:border-slate-800/50 pb-1.5 mb-1">
                ...
                <div className="grid grid-cols-3 gap-3.5">
                  ...
                  <div className="space-y-1">
                    <label className="text-[9px] font-extrabold uppercase tracking-wider text-slate-500 dark:text-white">Kanban Spec</label>
                    <input
                      type="number"
                      name="spec"
                      value={editForm.spec}
